...
[Live app](https://volta-npo.github.io/founder-story-interviewer/) · [Report an issue](https://github.com/volta-npo/founder-story-interviewer/issues) · [Volta](https://voltanpo.org)
...
```bash
git clone https://github.com/volta-npo/founder-story-interviewer.git
