...
**Founder Story Interviewer** is a polished, local-first open-source tool from Volta's open-source program. It helps Students producing founder videos, website copy, and social content turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
