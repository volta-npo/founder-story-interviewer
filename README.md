...
# 📣 Founder Story Interviewer

### Interview scripts and story extraction workflows for capturing a small business owner’s voice.
...
**Marketing & Content** · **Repo 22/50** · **No backend. No login. Client data stays local.**

[Live app](https://volta-npo.github.io/22-founder-story-interviewer/) · [Report an issue](https://github.com/volta-npo/22-founder-story-interviewer/issues) · [Volta](https://voltanpo.org)
...
**Founder Story Interviewer** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Students producing founder videos, website copy, and social content turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Authentic brand stories are hard for students to elicit without a structured interview process.

### The niche

Founder-led local businesses and nonprofits.

### North-star metric

`approved founder quotes captured per engagement`
...
flowchart TD
    ...
    Evidence --> Workbench["Founder Story Interviewer Interview"]
    Workbench --> Score["Content readiness"]
    Score --> Cert["v3 production certification"]
    Cert --> A1["Founder bio"]
    Cert --> A2["About page copy"]
    Cert --> A3["Social story pack"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Interview scripts"]
        M2["Quote bank"]
        M3["Story arc templates"]
        M4["Consent checklist"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Founder Story Interviewer
...
|---|---|
| **Domain workbench** | A purpose-built interview interface for interview scripts and story extraction workflows for capturing a small business owner’s voice. |
...
|---:|---|---|
| 1 | **Interview scripts** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Quote bank** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Story arc templates** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Consent checklist** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
- Quotes require consent
- Usage channels approved
- Sensitive topics flagged before export
...
```bash
git clone https://github.com/volta-npo/22-founder-story-interviewer.git
cd 22-founder-story-interviewer
npm test
npm start
```
