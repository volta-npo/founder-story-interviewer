  ...
  "criteria": [
    {
      ...
      "guidance": "Implement and verify interview scripts with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "quote-bank",
      "label": "Quote bank",
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify quote bank with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify story arc templates with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify consent checklist with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
