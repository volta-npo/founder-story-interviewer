export const v3 = {
    "productName": "Founder Story Interviewer",
    "productTier": "release",
    ...
    "capabilities": [
        "Domain-specific workbench: Founder Story Studio",
        "Operational table: Interview/quote bank",
    ...
    "releaseChecklist": [
        ...
        "Story Completeness reaches production threshold",
        "Consent Safety is documented with evidence",
        "Quote Quality has no unresolved blocker",
        "Founder bio verified",
        "About page copy verified",
        "Social story pack verified"
    ],
    "operations": [
